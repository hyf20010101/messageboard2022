...
export default {
  ...
  methods:{
    setUserName:function() {
      ...
      this.state.username=this.loginDialog.form.username;
      this.updateUsername(this.loginDialog.form.username);
      this.loginDialog.dialogVisible=false;
      CookieOperation.setCookie('user',this.state.username,60*60*1000);
      //console.log("logindialog "+this.state.username_valid.toString());
    },
  }
}
</script>
